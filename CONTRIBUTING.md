...
1. Ensure any install or build dependencies are removed before the end of the layer when doing a
   build.
2. Add or change [unittests](/tests/tests.py) that are specific to functionality according to [Development Guide](https://subzeroid.github.io/instagrapi/development-guide.html)
